...
class Player {
   ...
   *
   * [MODIFIED v4] Accepts optional skinDef from SkinSystem. When provided,
   * bodyColor/glowColor/visorColor override the defaults.
   *
   * @param {CanvasRenderingContext2D} ctx
   * @param {number[]}                 laneX   - Screen X per lane at z=1
   * @param {object|null}             [skinDef] - SkinSystem skin definition
   */
  render(ctx, laneX, skinDef = null) {
    ...
    // [NEW v4] Skin color overrides
    const bodyTop    = skinDef ? skinDef.bodyColor   : '#00ffff';
    const bodyBot    = skinDef ? skinDef.bodyColor   : '#0066cc';
    const glowCol    = skinDef ? skinDef.glowColor   : '#00ffff';
    const visorCol   = skinDef ? skinDef.visorColor  : 'rgba(0,255,255,0.85)';
    const accentCol  = skinDef ? skinDef.accentColor : 'rgba(255,255,255,0.4)';
